...
public class Grid : MonoBehaviour {
    ...
    public WorldGenerator generationReference;
    ...
    void Update()
    {
        if (generationReference.generationActive)
        {
            CreateGrid();
        }
    }
    ...
    void CreateGrid()
    {
        ...
        for (int x = 0; x < gridSizeX; x++)
        {
            for (int y = 0; y < gridSizeY; y++)
            {
                ...
                grid[x, y] = new Node(walkable, new Vector3(worldPoint.x, terrainHeight, worldPoint.z), x, y, movementPenalty);
            }
        }
    }
